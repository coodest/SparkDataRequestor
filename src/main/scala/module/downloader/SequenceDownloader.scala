...
import util.Requestor
import util.Splitter
import util.TargetUrl
import java.io.FileNotFoundException
import java.util.concurrent.CountDownLatch
import java.util.concurrent.locks.ReentrantLock

class SequenceDownloader(var context: Context) extends Downloader with Runnable {
  ...
  def run() {
    ...
    var temp: Array[String] = targetUrl.getTarget.toString.split("/")
